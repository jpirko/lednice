...
#define  USB_CFG_VENDOR_ID       0x09, 0x12 /* pid.codes */
...
#define  USB_CFG_DEVICE_ID       0x16, 0x57 /* lednice */
 ...
 */
#define USB_CFG_VENDOR_NAME     'J', 'i', 'r', 'i', ' ', 'P', 'i', 'r', 'k', 'o'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'l', 'e', 'd', 'n', 'i', 'c', 'e'
